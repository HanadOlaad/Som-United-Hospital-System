...
<!DOCTYPE html>
<html>
<?php $title="Som United Hospitals | Add blood samples"; ?>
    ...
    <div class="container cont">
      ...
      <div class="row justify-content-center">
        ...
        <form action="file/infoAdd.php" method="post">
          ...
          If your blood sample has been analyzed by a medical professional such as a doctor, nurse, or a trained phlebotomist at a pathology collection center, clinic, or hospital, it is typically obtained from the inner elbow area where the veins are more accessible. Prior to inserting the needle, the healthcare provider would clean the area with an antiseptic cloth. The blood sample is then collected into tubes that contain appropriate preservatives. Once the process is complete, your blood group information can be added to the blood bank records available at the hospital..<br><br>
        </div>
